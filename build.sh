...
EXTRA_CFLAGS="-DMICROPY_PY_SELECT=1 -DMICROPY_PY_ASYNCIO=1"
#EXTRA_CFLAGS="$EXTRA_CFLAGS -DMICROPY_PY_BLUETOOTH_ENABLE_CENTRAL_MODE=1"
EXTRA_CFLAGS="$EXTRA_CFLAGS -DMICROPY_PY_OS_DUPTERM=1"
